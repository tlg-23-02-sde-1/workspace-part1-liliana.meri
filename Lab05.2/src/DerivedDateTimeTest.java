...
import java.time.temporal.TemporalAdjusters;
import static java.time.DayOfWeek.*; // now you can say MONDAY instead of DayOfWeek
import static java.time.temporal.TemporalAdjusters.*;
...
class DerivedDateTimeTest {
    ...
    public static void testPresidentsFirst100Days() {
        ...
        //LocalDate deadline = inauguration
    }
    ...
    public static void testPopularBirthdays() {
        ...
        LocalDate birth2 = newYearDay.plusWeeks(38);
    ...
    public static void testEarlyRetirement() {
        LocalDate bday = LocalDate.of(1995, 3, 10);
    ...
    public static void testLaborDay() {
        LocalDate sept1 = LocalDate.of(1995, 3, 10);
